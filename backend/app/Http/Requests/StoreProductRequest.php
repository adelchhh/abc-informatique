...
class StoreProductRequest extends FormRequest
{
    ...
    /**
     * Nettoyer et formater le prix avant validation
    ...
    public function rules(): array
    {
        return [
            ...
            // Images optionnelles - accepter plusieurs images (1-5) ou une seule image pour compatibilité
            'images' => 'nullable|array|max:5',
            'images.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp,bmp,svg,tiff,ico|max:52428800', // 50MB par image
